...
namespace Zend\Expressive\ContentValidation\Exception;

use Exception as SplException;

/**
 * Class NoValidationClassExists
 *
 * @package Zend\Expressive\ContentValidation\Exception
 */
final class NoValidationClassExists extends SplException
{
